  ...
  return html.replace(
    ...
    `<div class="flex items-center gap-4 md:gap-8">
          <nav class="hidden md:flex space-x-8 items-center">
            ...
            <a href="news.html" class="text-emerald-500 font-bold text-sm transition-colors cursor-pointer flex items-center gap-1">News <span class="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span></a>
          </nav>
